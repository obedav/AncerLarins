...
class EstateController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        $validated = $request->validate([
            ...
            'estate_type' => ['required', 'string', \Illuminate\Validation\Rule::in(array_column(EstateType::cases(), 'value'))],
            ...
            'service_charge_period' => ['nullable', 'string', 'in:monthly,quarterly,yearly'],
    ...
    public function update(Request $request, Estate $estate): JsonResponse
    {
        ...
        $validated = $request->validate([
            ...
            'description' => ['nullable', 'string'],
            'estate_type' => ['sometimes', 'string', \Illuminate\Validation\Rule::in(array_column(EstateType::cases(), 'value'))],
            'developer' => ['nullable', 'string', 'max:255'],
            'year_built' => ['nullable', 'integer', 'min:1900', 'max:2100'],
            'total_units' => ['nullable', 'integer', 'min:1'],
            'amenities' => ['nullable', 'array'],
